...
SECRET_KEY = 'django-insecure-hotel-project-secret-key-change-in-production'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'hotel_password'),
...
# Wagtail settings
WAGTAIL_SITE_NAME = "Гостиничный бизнес"
